...
?>
		...
		<div class="card shadow mb-4">
		  	<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Edit Waiter Details
				</h6>
		  	</div>
		  ...
		  <!--	form-->
			...
			<div class="modal-footer" align="center">
				<a href="managewaiter.php" class="btn btn-danger"> Cancel </a>
				<button type="submit" name="updateWaiterbtn" class="btn btn-primary">Update</button>
			</div>
